...
<body class="bg-gray-100 p-2">
    <div class="max-w-4xl mx-auto mt-6 bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex gap-2">
            ...
            <a href="tambah_pemain.php" class="bg-blue-500 text-white px-2 py-2 rounded-lg shadow hover:bg-blue-600">
                <i class="fas fa-plus"></i>
            </a>
            <a href="laporan.php?updated=<?php echo time(); ?>" class="bg-green-500 text-white px-2 py-2 rounded-lg shadow hover:bg-green-600">
