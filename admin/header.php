    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <div class="sidenav-header-inner text-center"><img src="../img/was_logo.png" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5"><?php echo $_SESSION['nama']; ?></h2>
          </div>
        ...
        <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a href="blog_add.php"> <i class="icon-screen"> </i>Input Artikel</a></li>
             ...
             <li> <a href="project_tampil.php"> <i class="icon-screen"> </i>Jadwal Kegiatan</a></li>
          </ul>
      </div>
    </nav>
    <div class="page">
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                <li class="nav-item dropdown"> <a id="messages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-home fa-2x"></i><span class="badge badge-info"></span></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <H3>Nama : Doni Abiyantoro</H3>
          <H3>Copyright : <a href="https://api.whatsapp.com/send?phone=6285225106200">appsBee</a></H3>
