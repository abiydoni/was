    ...
    <div class="col-md-12">
          ...
          <div class="table-responsive">
              <table class="table table-striped">
                ...
                <?php
                    $no =1;
                      $qry = mysqli_query($konek,"SELECT * FROM tbl_user WHERE level=0");
                ...
                <tr>
                 ...
                 <td> <a href="user_hapus.php?id=<?php echo $data['kode']; ?>" class="fa fa-times" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"></td>
                </tr>
                <?php } ?>
