          ...
          <div class="row d-flex">
            <div class="col-lg-12">
                ...
                <div class="form-group row has-success">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="txtjudul" value="<?php echo $data['nama'] ?>" class="form-control is-valid" placeholder="Input">
                      </div>
            ...
            <?php
                 if (isset($_POST["btnedit"])){
                  ...
                  $edit = mysqli_query($konek,"UPDATE  tbl_bulan SET nama='$txtjudul', uraian='$txtbulan' WHERE kode='$id'");
                  if ($edit){
                    if(!empty($edit)){
                    ?>
